...
from winflow.graph import EDGE_TASK_ORDER, build_flow_graph_edges, default_job_key
...
class TestAnnotateJobRelations(unittest.TestCase):
    def test_annotate_writes_mutual_parents_children(self):
        from winflow.graph import annotate_job_relations, validate_job_relations
    ...
    def test_strip_job_relations_removes_fields(self):
        from winflow.graph import annotate_job_relations, strip_job_relations
